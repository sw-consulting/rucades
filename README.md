...
Для запуска криптографических примеров потребуется сертификат, связанный с закрытым ключом. Подробности по созданию тестового сертификата см. в документации КриптоПро.
